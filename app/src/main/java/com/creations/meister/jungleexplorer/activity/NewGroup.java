...
public class NewGroup extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onResume() {
        ...
        if(RuntimePermissionsHelper.hasPermissions(NewGroup.this, requiredPermissions)) {
            mImageView.setOnClickListener(this);
        }
    }

    private void initializeImageViewListener() {
        int hasReadContactsPermission = ContextCompat.checkSelfPermission(NewGroup.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE);
        if (hasReadContactsPermission != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(NewGroup.this,
                    requiredPermissions,
                    STORAGE_ASK_REQUEST);
            return;
        }
        ...
        switch (requestCode) {
            case STORAGE_ASK_REQUEST:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    mImageView.setOnClickListener(NewGroup.this);
                } else {
