 ...
 */
package com.creations.meister.jungleexplorer.utils.async_task_thread_pool;
...
public abstract class AsyncTaskEx<Params, Progress, Result> {
     ...
     * If {@link #getStatus()} returns either {@link com.creations.meister.jungleexplorer.utils.async_task_thread_pool.AsyncTaskEx.Status#RUNNING} or {@link com.creations.meister.jungleexplorer.utils.async_task_thread_pool.AsyncTaskEx.Status#FINISHED}.
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that CustomAsyncTask#onPostExecute has finished.
         */
        FINISHED,
    }
